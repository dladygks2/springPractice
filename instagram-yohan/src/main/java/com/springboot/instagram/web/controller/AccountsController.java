...
public class AccountsController {
	...
	@PutMapping("/accounts/edit") // update에 사용하는 mapping
	public boolean profileEdit(@AuthenticationPrincipal PrincipalDetails principalDetails,
	...
	public Object passwordChange(@AuthenticationPrincipal PrincipalDetails principalDetails,
			PasswordReqDto passwordReqDto) {
