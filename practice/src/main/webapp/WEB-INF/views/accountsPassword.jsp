...
<link rel="stylesheet" href="/css/accountsPassword.css">
...
<body>
	<section>
		...
		<main>
			<div class="container">
				<ul class="menu-list">
					<li class="menu-li"><a href="/accountsEdit" class="menu-li-a">프로필
							편집</a></li>
					<li class="menu-li"><a href="accountsPassword.html"
						class="menu-li-a-select">비밀번호 변경</a></li>
				</ul>
				<article>
					...
					<div class="password-items">
						<aside>
							<label for="new-repassword-ip" class="password-lb">새 비밀번호
								확인</label>
						</aside>
						<div class="password-ip">
					...
					<div class="password-items">
						<aside></aside>
						<div class="password-ip">
							<button type="button" class="password-submit-btn">비밀번호
								변경</button>
						</div>
					</div>
				</article>
