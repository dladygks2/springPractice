...
public class UserRepositoryImpl implements UserRepository{
	...
	public List<User> getUserAll(){
		return sqlSession.selectList( NAME_SPACE + "getUserAll"); // namespace + id 로 입력
...
//	@Override
//	public List<User> getUserAll(){
//		return sqlSession.selectOne("com.spring.study.domain.user.UserRepository.getUserAll"); // namespace + id 로 입력
//
//	}
